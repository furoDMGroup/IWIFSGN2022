...
parkinson = pd.read_csv(pth.concatenate_path_os_independent('train_data.txt'), header=None)
    ...
    for k in ks:
        for agg in aggs:
            ...
            f_result = cross_validate_missing_in_test(binaryF, X, y,
                                                      scoring='roc_auc', return_estimator=True, cv=skf, inserter=inserter, dataset='parkinson')
...
concatenated.to_excel('concatenated_parkinson.xlsx')